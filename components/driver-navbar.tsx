...
import { Menu, User, LogOut, Home, CreditCard, HelpCircle, BarChart } from "lucide-react"
...
export function DriverNavbar({ user }: DriverNavbarProps) {
          ...
          <div className="flex items-center space-x-2">
            ...
            <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={() => router.push("/driver/wallet")}>
                  <CreditCard className="mr-2 h-4 w-4" />
                  Wallet
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => router.push("/driver/help")}>
