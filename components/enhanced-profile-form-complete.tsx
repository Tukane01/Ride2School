...
import { enhancedProfileValidator, ProfileUpdateException, ErrorRecovery } from "@/lib/profile-validation-enhanced"

interface EnhancedProfileFormCompleteProps {
...
export default function EnhancedProfileFormComplete({
  userType,
  initialData,
  onSuccess,
  onError,
}: EnhancedProfileFormCompleteProps) {
  ...
  // Real-time validation with all registration exceptions
  const validateField = (field: string, value: string, formType: "personal" | "child" | "car") => {
    try {
      enhancedProfileValidator.clearErrors()

      switch (formType) {
        case "personal":
          enhancedProfileValidator.validatePersonalInfo({ [field]: value })
          break
        case "child":
          enhancedProfileValidator.validateChildInfo({ [field]: value })
          break
        case "car":
          enhancedProfileValidator.validateVehicleInfo({ [field]: value })
          break
      }
  ...
  const handlePersonalChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    // Sanitize input based on field type with all registration rules
  ...
  const handleChildChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    // Sanitize input with all registration rules
    let sanitizedValue = value
    if (name === "name" || name === "surname") {
      sanitizedValue = ErrorRecovery.sanitizeInput(value, "name")
  ...
  const handleSavePersonal = async (e: React.FormEvent) => {
    ...
    try {
      // Validate all fields with registration exceptions
      const validation = enhancedProfileValidator.validatePersonalInfo(personalForm)
      ...
      if (validation.warnings.length > 0) {
        setWarnings({ general: validation.warnings })
      }
  ...
  const handleSaveChild = async (e: React.FormEvent) => {
    ...
    try {
      // Validate all fields with registration exceptions
      const validation = enhancedProfileValidator.validateChildInfo(childForm)
  ...
  const handleSaveCar = async (e: React.FormEvent) => {
    ...
    try {
      // Validate all fields with registration exceptions
      const validation = enhancedProfileValidator.validateVehicleInfo(carForm)
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Minimum 3 characters, letters only"
                    required
                  />
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">Email cannot be changed (must be Gmail)</p>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Must start with 06, 07, or 08"
                    maxLength={10}
                    required
                  />
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">ID number cannot be changed (13 digits)</p>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    ...
                    rows={3}
                    placeholder="Minimum 10 characters, include street number"
                    required
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    ...
                    rows={3}
                    placeholder="Complete school address, minimum 10 characters"
                    required
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Letters only, e.g., White, Black"
                    required
                  />
