...
-- Recreate the function with proper foreign key handling
...
BEGIN
  ...
  -- This prevents foreign key constraint violations when deleting the ride
  UPDATE transactions 
  SET ride_id = NULL, 
      description = CONCAT(description, ' (Original ride cancelled by driver)')
